...
void    iperf_set_test_pktdir( struct iperf_test* ipt, const char *pktdir );
...
int iperf_open_pktfile(struct iperf_stream *);
...
enum {
    ...
    IEPKTFILE = 33,     // Can't open pkt file
    /* Test errors */
